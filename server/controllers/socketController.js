        ...
        if (decidee) {
            ...
            if (lobby_id) {
                ...
                if (result.length === 0) {
                    ...
                    return res.status(200).send({ onlineFriendSockets, decidee_id })
                }
                return res.status(201).send({ lobby_id, onlineFriendSockets, decidee_id })
            }
        }
        res.status(200).send({ onlineFriendSockets, decidee_id })
    }
}